        ...
        <div class="main_container">
            <div class="container">
                ...
                elseif (isset($_GET['remove']))
                {
                    ...
                    $mysqli->queryOne("DELETE FROM friends
                ...
                foreach ($r as $row)
                {
                    ...
                    elseif ($t1 == 'followed')       { echo "<span class='member_status'> &rarr; is following you</span>";
                                        $follow = "recip"; }
                    
                    if (!$t1) echo " [<a data-transition='slide' class='member_info'
